...
def test_componentdidcatch_can_recover_by_rendering_an_element_of_the_same_type() -> None:
    # Upstream: ErrorBoundaryReconciliation-test.internal.js
    # "componentDidCatch can recover by rendering an element of the same type"
    ...
    class Boundary(Component):
        ...
        def render(self) -> object:
            if bool(self.state.get("hasError")):
                return create_element("div", {"text": "recovered"})
