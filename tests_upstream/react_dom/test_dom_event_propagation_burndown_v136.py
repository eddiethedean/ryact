...
def _assert_bubbles_nested(*, react_event: str, dispatch_type: str, parent_tag: str, child_tag: str) -> None:
    log: list[str] = []
...
def test_onanimationiteration_6c3157d6() -> None:
    _assert_bubbles(
        react_event="onAnimationIteration", dispatch_type="animationiteration", host_tag="div", expect_parent=True
    )
...
def test_onfullscreenchange_4562d42f() -> None:
    _assert_bubbles(
        react_event="onFullscreenChange", dispatch_type="fullscreenchange", host_tag="div", expect_parent=True
    )


def test_onfullscreenerror_e34a9405() -> None:
    _assert_bubbles(
        react_event="onFullscreenError", dispatch_type="fullscreenerror", host_tag="div", expect_parent=True
    )


def test_ongotpointercapture_c2fd509a() -> None:
    _assert_bubbles(
        react_event="onGotPointerCapture", dispatch_type="gotpointercapture", host_tag="div", expect_parent=True
    )
...
def test_onlostpointercapture_4e6ad61e() -> None:
    _assert_bubbles(
        react_event="onLostPointerCapture", dispatch_type="lostpointercapture", host_tag="div", expect_parent=True
    )
...
def test_ontransitioncancel_1d044363() -> None:
    _assert_bubbles(
        react_event="onTransitionCancel", dispatch_type="transitioncancel", host_tag="div", expect_parent=True
    )
...
def test_ontransitionstart_cc2b9191() -> None:
    _assert_bubbles(
        react_event="onTransitionStart", dispatch_type="transitionstart", host_tag="div", expect_parent=True
    )
...
def test_onmouseenterandonmouseleave_06933522() -> None:
    _assert_enter_leave(
        enter_prop="onMouseEnter", leave_prop="onMouseLeave", over_type="mouseover", out_type="mouseout"
    )


def test_onpointerenterandonpointerleave_b20c2ea2() -> None:
    _assert_enter_leave(
        enter_prop="onPointerEnter", leave_prop="onPointerLeave", over_type="pointerover", out_type="pointerout"
    )
...
def test_oncanplaythrough_9bb05308() -> None:
    _assert_bubbles_nested(
        react_event="onCanPlayThrough", dispatch_type="canplaythrough", parent_tag="div", child_tag="video"
    )
...
def test_ondurationchange_5c597dca() -> None:
    _assert_bubbles_nested(
        react_event="onDurationChange", dispatch_type="durationchange", parent_tag="div", child_tag="video"
    )
...
def test_onloadedmetadata_24c9af8c() -> None:
    _assert_bubbles_nested(
        react_event="onLoadedMetadata", dispatch_type="loadedmetadata", parent_tag="div", child_tag="video"
    )
...
def test_onvolumechange_68987be7() -> None:
    _assert_bubbles_nested(
        react_event="onVolumeChange", dispatch_type="volumechange", parent_tag="div", child_tag="video"
    )
...
def test_oncompositionstart_0fc93d83() -> None:
    _assert_bubbles(
        react_event="onCompositionStart", dispatch_type="compositionstart", host_tag="div", expect_parent=True
    )


def test_oncompositionupdate_ad6c838f() -> None:
    _assert_bubbles(
        react_event="onCompositionUpdate", dispatch_type="compositionupdate", host_tag="div", expect_parent=True
    )
