#!/usr/bin/env python3
"""
Regenerate tests_upstream/react/upstream_inventory.json from a facebook/react checkout.
...
Usage:
  python scripts/update_react_upstream_inventory.py /path/to/react
"""
...
def main() -> int:
    ...
    from react_jest_extract import canonical_case_key, extract_all, stable_case_id
    ...
    for ex in extracted:
        ...
        # If you promote a row to implemented, ensure manifest_id exists.
